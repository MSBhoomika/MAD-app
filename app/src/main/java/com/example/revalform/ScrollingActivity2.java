...
public class ScrollingActivity2 extends AppCompatActivity implements TextWatcher{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> semAdapter=new ArrayAdapter<String>(ScrollingActivity2.this,
    ...
    public void addRows(){
        ...
        total.setText(Integer.toString(100 * n));
    ...
    public void submitReval(View v) {
        ...
        CollectionReference notebookRef = db.collection("CSERecounting").document("sem").collection(sem);
        ...
        notebookRef.document(usn).set(note)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(ScrollingActivity2.this, "Form has been submitted", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ScrollingActivity2.this, "Error!", Toast.LENGTH_SHORT).show();
    ...
    void payUsingUpi(String amount, String upiId,String name, String note) {
        ...
        if(null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(ScrollingActivity2.this,"No UPI app found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(ScrollingActivity2.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(ScrollingActivity2.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
                Log.d("UPI", "responseStr: "+approvalRefNo);
                submit.setEnabled(true);
                editTextNum.setEnabled(false);
            }
            else if("Payment cancelled by user.".equals(paymentCancel)) {
                Toast.makeText(ScrollingActivity2.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(ScrollingActivity2.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(ScrollingActivity2.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }
