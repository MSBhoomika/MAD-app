...
public class ScrollingActivity extends AppCompatActivity implements TextWatcher{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> semAdapter=new ArrayAdapter<String>(ScrollingActivity.this,
    ...
    void payUsingUpi(String amount, String upiId,String name, String note) {
        ...
        if(null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(ScrollingActivity.this,"No UPI app found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(ScrollingActivity.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(ScrollingActivity.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
                Log.d("UPI", "responseStr: "+approvalRefNo);
                submit.setEnabled(true);
                editTextNum.setEnabled(false);
            }
            else if("Payment cancelled by user.".equals(paymentCancel)) {
                Toast.makeText(ScrollingActivity.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(ScrollingActivity.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(ScrollingActivity.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }
